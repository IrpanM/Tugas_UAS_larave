...
<section class="content">
    <div class="container-fluid">
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form method="post" action="{{ route('info.update', $item->id) }}" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="kategori" class="form-control" id="kategori" placeholder="Enter Image">
                    </div>
                    <div class="form-group">
                        <label for="date">Date</label>
                        <input type="datetime-local" name="date" class="form-control" id="date" placeholder="Enter Date"
                            value="{{$item->date}}">
                    </div>
                    <div class="form-group">
